...
public class CommentController extends BaseController {
	...
	public void addComment() {
		...
		log.info("name=" + subjectId + "majorId=" + text + "tags=" + tags);

		if (StrKit.isBlank(subjectId) || StrKit.isBlank(param.get("text")) || StrKit.isBlank(param.get("pic"))) {
			renderJson(Ret.fail("msg", "请求参数为空"));
			return;
		}
		renderJson(commentService.add(userId,param));
	}
